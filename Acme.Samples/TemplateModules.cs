...
public class TemplateModules : AbpModule
{
    ...
    public override void PostConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            //     .Configure(typeof(Volo.Abp.Account.Web.Pages.Account.LoginModel).FullName,
            //         configuration =>
            //         {
            //             configuration.AddFiles("/LoginFix.css");
            //         });
            //
            options.ScriptBundles
                .Configure(typeof(Volo.Abp.Account.Web.Pages.Account.LoginModel).FullName,
                    configuration =>
                    {
                        configuration.AddFiles("/LoginFix.js");
                    });
        });
    }
...
public class BillingMenuContributor : IMenuContributor
{
    ...
    private async Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        context.Menu.AddItem(new ApplicationMenuItem("BillingMenus.Categoria", l["Articulo"], "/Articulo"));
    }
}